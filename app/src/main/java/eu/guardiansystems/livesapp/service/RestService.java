...
import eu.guardiansystems.livesapp.models.Shared.Rest;
...
public class RestService extends IntentService {
		...
		public static final String ACTIVITY_STREAM_URL = "https://dev.livesapp.io/api/articles";
		...
		public static final String UPDATE_URL = "https://dev.livesapp.io/api/android";
		...
		protected void onHandleIntent(Intent intent) {
				...
				try {
						if (command.equals(ACTIVITY_STREAM_COMMAND)) {
								long timestamp = intent.getLongExtra(LAST_TIMESTAMP, 0);
								bundle.putString(ACTIVITY_STREAM_CALLBACK, getNews(timestamp));
		...
		public static String getNews(long timestamp) throws HttpResponseException {
				String newsUrl = ACTIVITY_STREAM_URL + "/" + APPLICATION.getDispatcherId() + "/" + timestamp + "/20";
